...
export const imageApi = {
    ...
    convert: (imageUrl: string, strategy?: string, forceConvert?: boolean, storageKey?: string, isMoodboard?: boolean) =>
        api.post('/image/convert', { imageUrl, strategy, forceConvert, storageKey, isMoodboard }).then(res => res.data),
