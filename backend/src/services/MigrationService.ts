...
export class MigrationService {
    ...
    private static async migrateDesigners(job: Job) {
        ...
        const designersToMigrate = fullList.filter((d: any) => job.items.includes(d.id));
        ...
        for (const designer of designersToMigrate) {
            ...
            try {
                ...
                if (designer.coverUrl) {
                    ...
                    coverKey = `designers/${slug}/cover.webp`;
    ...
    private static async migrateMoodboard(job: Job) {
        ...
        const productsToMigrate = fullList.filter((p: any) => job.items.includes(p.id));
